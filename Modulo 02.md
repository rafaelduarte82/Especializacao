...
Prompt: "Escreva um conto curto sobre um engenheiro de softwares que descobre um portal mágico para um mundo habitado por duendes programadores . O conto deve ter um tom sarc e explorar temas como [amizade/coragem/superação]."
Dicas:
