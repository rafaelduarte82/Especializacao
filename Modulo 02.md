...
Prompt: "Escreva um conto curto sobre um engenheiro que descobre um portal mágico para um mundo habitado por [criaturas fantásticas]. O conto deve ter um tom [humorístico/sombrio/reflexivo] e explorar temas como [amizade/coragem/superação]."
Dicas:
